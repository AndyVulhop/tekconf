...
namespace TekConf.RemoteData.v1
{
	public class RemoteDataRepository
	{
		...
		public void AddSessionToSchedule(string conferenceSlug, string sessionSlug, string authenticationMethod, string authenticationToken, string userName, string password, Action<ScheduleDto> callback)
		{
